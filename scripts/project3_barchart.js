import crimes_data from "../Total.json" assert {type: 'json'};
import chicago_communities from "../map_files/community.geojson" assert {type: 'json'};
...
export function barChart_project02() {
